/**
	@file
	@brief TweetNaCl library with some small cleanup

	1) signed/unsigned mismatches in loop bounds checks fixed
	2) chacha/poly implementation deleted
    3) crypto_sign_keypair takes 32 random bytes in sk, rather than generating them internally.
       Also doesn't store public key at end of secret key.
 */
#include "tweetnacl_25519.h"
